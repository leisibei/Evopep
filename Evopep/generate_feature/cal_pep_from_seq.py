...
if __name__ == "__main__":
    ...
    file = r'E:\LS\深度学习\code\code_new_0815\practice-cxy\排序后\rank_result_10-20_1000_20250708.csv' # 待计算table特征的文件
    output_path = r'E:\LS\深度学习\code\code_new_0815\practice-cxy\排序后\rank_result_10to20_1000_descriptor_cxy.csv'  # 保存路径以及文件名字
