...
if __name__ == '__main__':
    AMP_model = torch.load('../trained_model/CNN/AMP/fold1_20230814.pt')  # 使用哪个模型，可以修改
    CPP_model = torch.load('../trained_model/CNN/CPP/fold1_20230814.pt')  # 使用哪个模型，可以修改
    ...
    save_path = r'E:\LS\深度学习\代码\code_new_0815\practice\2_AI预测可能性文件夹\CNN'
